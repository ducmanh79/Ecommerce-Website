    ...
    <div class="container text-start product-information" v-if="data">
      ...
      <div class="row">
        ...
        <div id="color-selector">
          <p v-if="selected">Selected color: {{newProduct.color}}</p>
          <ul>
        ...
        <div id="memory-selector" class="mb-2">
          <p v-if="memSelected">Selected memory of {{newProduct.memory}}</p>
          <ul>
...
export default {
  ...
  data() {
    return {
      ...
      data: null,
      productImages: null,
      newProduct: {color: null, memory: null},
      selected: false,
      memSelected: false,
      option: {
        navButtons: false,
  ...
  methods: {
    ...
    assignColor(col){
      this.newProduct.color = col;
      this.selected = true;
    },
    assignMem(mem){
      this.newProduct.memory = mem;
